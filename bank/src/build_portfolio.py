...
<body><main>
  ...
  <section class="grid" aria-label="대회 리포트">
    <a class="card" href="playground-series-s5e4/"><div class="tag">PLAYGROUND S5E4</div><h2>Podcast Listening Time</h2><p>청취시간 회귀 문제의 결측, 극단값, 강한 길이 관계와 검증 설계를 분석합니다.</p><span class="status">EDA 완료 · 기준선 준비</span></a>
