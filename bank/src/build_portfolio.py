...
REPORTS = {
    ...
    "welding-manufacturing": ROOT / "welding-manufacturing" / "docs" / "index.html",
}
...
<body><main>
  ...
  <h1>데이터 분석 대회 기록</h1>
  <p class="lead">Kaggle과 제조데이터 대회에서 무엇을 확인했고, 무엇을 발견했으며, 다음 실험을 왜 선택했는지 정리합니다.</p>
  <section class="grid" aria-label="대회 리포트">
    ...
    <a class="card" href="welding-manufacturing/"><div class="tag">KAMP · WELDING</div><h2>로봇용접 제조데이터</h2><p>측정값 11,939행의 품질, 불량 집계 라벨의 의미와 모델링 전 필수 확인사항을 분석합니다.</p><span class="status">기초 EDA · 라벨 확인 단계</span></a>
  </section>
